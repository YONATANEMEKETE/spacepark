...
const StoryCard = ({ name, image, story, variant }: Props) => {
  if (variant === 'add') {
    return (
      <div
        ...
        className="w-[19%] h-[200px]  rounded-xl bg-cover px-2 py-4 cursor-pointer flex flex-col gap-3 justify-end items-center"
      >
  ...
  return (
    <div
      ...
      className="w-[19%] h-[200px]  rounded-xl bg-cover px-2 py-4 cursor-pointer flex flex-col justify-between items-center"
    >
      <div
